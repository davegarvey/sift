# feed-refresh-status Specification

## Purpose
This capability defines how feed refresh state and failures are presented in the client, keeping the interface quiet for conditions that need no user action.
